...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
        ...
        <!-- Total Kelas -->
        <div
            class="p-4 bg-gradient-to-r from-blue-50 to-white border border-blue-100 rounded-xl shadow-sm flex items-center gap-4">
            <div class="w-10 h-10 bg-blue-400 rounded-full flex items-center justify-center text-xl"><i
                    class="ri-book-open-line text-xl text-white"></i></div>
            <div>
        ...
        <div
            class="p-4 bg-gradient-to-r from-blue-50 to-white border border-blue-100 rounded-xl shadow-sm flex items-center gap-4">
            <div class="w-10 h-10 bg-blue-400 rounded-full flex items-center justify-center text-xl"><i
                    class="ri-file-list-2-line text-white"></i></div>
            <div>
